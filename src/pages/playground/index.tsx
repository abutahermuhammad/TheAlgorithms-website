...
import { createNewPlayground } from "src/lib/playground";
...
import { getTest } from "src/lib/playground/livecodes";

const PlaygroundEditor = dynamic(() => import("src/components/playgroundEditor"), {
  ssr: false,
});
